                ...
                if (isMwayMessage) {
                    try {
                        ...
                        if (deviceBroadcast.messageType == MESSAGE_TYPE_DEVICE_BROADCAST) {
                            ...
                            if (deviceBroadcast.deviceType == Constants.DEVICE_TYPE_BIKE && (dataManager.isRightTurn || dataManager.isLeftTurn) && sensorManager.isMyDirection(deviceBroadcast.direction)) {
